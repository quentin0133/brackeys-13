...
var data_game = {
	...
	"scene_wakywaky" : ['Waky waky','Description',2,'','',0,0,false],
	"scene_grand_mother" : ['Grand Mother Game','Description',3,'','Last time','',time_score,true],
	"scene_dont_answer" : ['Father Fouras','Description',4,'','','','',false],
	"scene_monologue" : ['Monologue','Description',5,'','',0,0,false]
